using Internal = ElCavernas.Govrnz.Registry.Core.Model;
using External = Elcavernas.Govrnz.Registry.WebApi.Model;
using System;
...
namespace Elcavernas.Govrnz.Registry.WebApi.Model.Mappers
{
